...
int main(void) //  global function
{
    void tokenizing(); //  desired function to be called
    {
        ...
        gets(phrase);                                                    // gets function to scan and store string

        while (strcmp(phrase, "q") != 0) // if condition to check if the input is "q"
        {
            phrase = strtok(phrase, ","); // It will break the string and will continue from the next line
